...
public class DeleteCustomer extends javax.swing.JFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        boolean deleteCustomer = CustomerController.deleteCustomer(idText.getText());
        if (deleteCustomer) {
            JOptionPane.showMessageDialog(this, "Successfully Removed", "Alert", 1);
        } else {
            idText.setText(null);
            ...
            JOptionPane.showMessageDialog(this, "Failed to Remove Customer", "Alert", 3);
            idText.requestFocus();
        }
